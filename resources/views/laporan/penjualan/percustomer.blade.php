  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2>Laporan Penjualan <small>{{ date('d/m/Y', strtotime($search['from']))." s.d ".date('d/m/Y', strtotime($search['to'])) }}</small></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <br />
            ...
            <div class="row">
              ...
              <div class="col-md-2" align="right">
                <a href="{{ route('Print Laporan Penjualan Per Customer', 'print') }}?from={{ $search['from'] }}&to={{ $search['to'] }}" target="_blank" class="btn btn-info" onclick="">
          ...
          foreach ($listLaporan['header'] as $key => $value) {
            echo "<h5>" . $value->nama_customer . "</h5>";
          ?>
              ...
              <table class="table table-striped jambo_table">
                <thead>
                  <tr class="headings">
                    ...
                    <th class="column-title" style="text-align: right;">Total Penjualan </th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <form method="GET" action="{{ route('Laporan Penjualan Per Customer') }}" id="formFilter">
