...
<head>
  ...
  if ($type == 'download') {
    ...
    header('Content-Disposition: attachment; filename="Laporan Penjualan Rangkuman.pdf"');
  }
  ?>
</head>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12" align="center">
        ...
        <h5><b>Laporan Penjualan Rangkuman</b></h5>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              foreach ($listLaporan as $laporan) {
                ...
                $total_saldo += $laporan->grandtotal - $laporan->terbayar;
              ?>
                <tr>
                  <td>{{ $no }}</td>
