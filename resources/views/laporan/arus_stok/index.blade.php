  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2>Laporan Arus Stok <small>{{ date('d/m/Y', strtotime($search['from']))." s.d ".date('d/m/Y', strtotime($search['to'])) }}</small></h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <br />
            ...
            <table class="table table-striped jambo_table">
              <thead>
                <tr class="headings">
                  ...
                  <th class="column-title no-link last" style="text-align: right;">Keluar </th>
                </tr>
              </thead>
              <tbody>
                <?php
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <form method="GET" action="{{ route('Laporan Arus Stok') }}" id="formFilter">
